...
@NamedQueries({
    ...
    @NamedQuery(name = "Usuario.findByIdLista", query = "SELECT u FROM Usuario u WHERE u.idLista = :idLista")})
public class Usuario implements Serializable {
    ...
    public Usuario(Integer id, String nome, String email, double telefone, String senha, String endereco, String cidade, String uf, int idLista) {
        this.id = id;
        this.nome = nome;
        this.email = email;
